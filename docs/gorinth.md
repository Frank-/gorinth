...
A CLI tool for updating Minecraft server mods from Modrinth.
...
* [gorinth check](gorinth_check.md)	 - Check for updates to your Minecraft server mods without applying them.
* [gorinth completion](gorinth_completion.md)	 - Generate the autocompletion script for the specified shell
* [gorinth update](gorinth_update.md)	 - Check for updates and apply them to your Minecraft server mods.
