...
To load completions in your current shell session:
	...
	source <(gorinth completion zsh)

To load completions for every new session, execute once:

#### Linux:

	gorinth completion zsh > "${fpath[1]}/_gorinth"

#### macOS:

	gorinth completion zsh > $(brew --prefix)/share/zsh/site-functions/_gorinth

You will need to start a new shell for this setup to take effect.


```
gorinth completion zsh [flags]
```
